...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='multistain_cyclegan')
        ...
        parser.add_argument('--netD_opt', type=str, default='adam')
        ...
        # augmentation
        parser.add_argument('--color_augment', dest='color_augment', default=True, action='store_true')
        parser.add_argument('--brightness', type=float, default=0.75)
        ...
        # discriminator
        parser.add_argument('--D_thresh', dest='D_thresh', default=False, action='store_true')
        parser.add_argument('--D_thresh_value', type=float, default=1)
